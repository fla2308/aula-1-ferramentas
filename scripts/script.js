...
function manipularElementos()  {
    ...
    buttonsAll.forEach(button => {
     ...
     const listItems = document.querySelectorAll("u~l li b");
...
function navegarEManipularDOM(){
    ...
    segundasection.firstChild.nextElementSibling.textContent = "Título da seção 2 alterado"
  }
...
function enviarParaWhatsApp() {
    ...
    const numeroWhatsApp = '5581992657062'; // Insira o número de telefone do WhatsApp aqui (apenas números)
